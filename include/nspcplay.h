...
int32_t nspcplayLoadSequencePack(struct NSPCPlayer* player, const uint8_t* const data, size_t dataLength);
int32_t nspcplayLoadInstrumentPack(struct NSPCPlayer* player, uint8_t* buffer, uint8_t const * const data, size_t dataLength);
int32_t nspcplayInitializeInstruments(struct NSPCPlayer* player, uint8_t const * const buffer, uint16_t instrumentBase, uint16_t sampleBase);
